...
RUN echo "https://mirrors.pardisco.co/alpine/v3.22/main" > /etc/apk/repositories
RUN echo "https://mirrors.pardisco.co/alpine/v3.22/community" >> /etc/apk/repositories
