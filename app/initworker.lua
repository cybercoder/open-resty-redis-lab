...
metric_requests = prometheus:counter(
    ...
    { "host", "method", "status", "cdn_namespace", "cdn_gateway" })
...
metric_http_bytes_sent = prometheus:counter(
    "nginx_http_bytes_sent", "Bytes sent by openresty.", { "host", "cdn_namespace", "cdn_gateway", "cache_status" })
metric_http_bytes_received = prometheus:counter(
    "nginx_http_bytes_received", "Bytes received by openresty.",
    { "host", "cdn_namespace", "cdn_gateway", "cache_status" })
